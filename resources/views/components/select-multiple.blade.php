...
<div class="pt-2">
            ...
            <div class="inline-block relative flex flex-col w-full">
                <div class="flex flex-col items-center relative">
                    <div x-on:click="open" class="w-full  svelte-1l8159u">
                        <div class="my-1 p-1 flex border border-gray-200 bg-white rounded svelte-1l8159u">
	...
	L17.418,6.109z"/>
                            ...
                            <button type="button" x-show="isOpen() === false" @click="close"
                                    class="cursor-pointer w-6 h-6 text-gray-600 outline-none focus:outline-none">
                                <svg class="fill-current h-4 w-4" viewBox="0 0 20 20" style="transform: rotate(180deg)">
